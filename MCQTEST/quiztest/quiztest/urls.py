...
urlpatterns = [
    ...
    path('correctanswer',views.correct,name='quizstart'),
    path('question1',views.quest1,name='answer1'),
    path('rightall',views.right,name='rightanswer2'),
    path('question2',views.ans2,name='quest2'),
